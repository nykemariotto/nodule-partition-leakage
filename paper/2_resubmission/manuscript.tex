...
cross-validation. Across $n=15$ matched folds (3 repeats $\times$ 5 folds) and two convolutional
...
and survived re-scoring both arms on identical test rows. A third, nodule-grouped arm separates the
